...
const TECHNOLOGIES = [
  ...
  },
  {
    ...
    self_install_potential: 5,
    margin_potential: 5,
    value_stack: ['Truck-roll avoidance / contractor margin', 'Remote refrigerant leak detection', 'Energy + performance anomaly alerts', 'Sensor-verified commissioning', 'AIM Act / F-gas compliance'],
    portfolio: 'Thalo Labs (Sidekick — cellular HVAC monitoring sold to contractors)',
    note: 'The customer is the HVAC contractor, not the building owner — and the unit economics are why. A residential service truck roll costs the contractor roughly $250–500 fully loaded (tech hours, drive time, vehicle, parts-truck capacity); commercial diagnostic visits run $500–1,500. Most service calls today are reactive and partially blind: the tech arrives, diagnoses on-site, then often returns a second time with the right part. Sidekick inverts that. Cellular sensors (no Wi-Fi handoff) sit non-invasively inside refrigerant-based systems and continuously stream pressure, temperature, runtime, and energy-consumption data, so the contractor can remotely flag refrigerant leaks, performance degradation, abnormal energy draw, and commissioning errors before the customer calls. The economics: avoid the truck roll entirely, or arrive once with the right tech and the right part, or upsell a proactive service contract priced off the monitoring feed. Reactive repair runs 3–5× the cost of proactive. Compounding tailwinds: nearly 1-in-4 new heat pump installs need a return visit (mostly refrigerant charge issues Sidekick catches at commissioning), US heat pumps outsold gas furnaces for 4 years running per IEA, and the A2L refrigerant transition + EPA AIM Act + EU F-gas Regulation are tightening leak rules in parallel. Commissioning quality and remote diagnosis become the choke point of the electrification rollout — Sidekick monetizes the choke point. NYC affordable-housing case: 9 failing VRF heat pumps diagnosed remotely before any truck rolled.',
